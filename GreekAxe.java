...
public class GreekAxe extends ItemAxe {
     ...
     */
    public GreekAxe(int par1, EnumToolMaterial toolMaterial, float knockBack, double reach, int minDamage, int maxDamage, int chargeCapacity)
    {
