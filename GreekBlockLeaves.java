...
public class GreekBlockLeaves extends BlockLeavesBase implements IShearable
{
    public static final String[] LEAF_TYPES = new String[] {"olive"};
    public static final String[][] field_94396_b = new String[][] {{GreeceInfo.NAME.toLowerCase() + ":leaves_olive"}, {GreeceInfo.NAME.toLowerCase() + ":leaves_olive_opaque"}};
    ...
    int leafType; // 0=normal, 1=ripe
    Random growthTime = new Random();
    
    protected GreekBlockLeaves(int par1, int type)
    {
    ...
    /*public Icon getIcon(int par1, int par2)
    {
    	...
    	return GreeceInfo.NAME.toLowerCase() + ":leaves_olive_ripe";
    }*/
