...
public class GreekComponentVillageWell extends GreekComponentVillage
{
    public GreekComponentVillageWell() {}

    public GreekComponentVillageWell(GreekComponentVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, int par4, int par5)
    {
    ...
    {
        GreekStructureVillagePieces.getNextStructureComponentVillagePath((GreekComponentVillageStartPiece)par1StructureComponent, par2List, par3Random, this.boundingBox.minX - 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, 1, this.getComponentType());
        GreekStructureVillagePieces.getNextStructureComponentVillagePath((GreekComponentVillageStartPiece)par1StructureComponent, par2List, par3Random, this.boundingBox.maxX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, 3, this.getComponentType());
        GreekStructureVillagePieces.getNextStructureComponentVillagePath((GreekComponentVillageStartPiece)par1StructureComponent, par2List, par3Random, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ - 1, 2, this.getComponentType());
        GreekStructureVillagePieces.getNextStructureComponentVillagePath((GreekComponentVillageStartPiece)par1StructureComponent, par2List, par3Random, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.maxZ + 1, 0, this.getComponentType());
    }
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 1, 0, 1, 4, 12, 4, Greece.plasteredBlock.blockID, Block.waterMoving.blockID, false);
        ...
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 1, 15, 1, 4, 15, 4, Greece.plasteredBlock.blockID, Greece.plasteredBlock.blockID, false);
