...
public class GreekComponentVillageStartPiece extends GreekComponentVillageWell
{
    ...
    public GreekStructureVillagePieceWeight structVillagePieceWeight;
    ...
    public GreekComponentVillageStartPiece() {}

    public GreekComponentVillageStartPiece(WorldChunkManager par1WorldChunkManager, int par2, Random par3Random, int par4, int par5, List par6List, int par7)
    {
    	super((GreekComponentVillageStartPiece)null, 0, par3Random, par4, par5);
