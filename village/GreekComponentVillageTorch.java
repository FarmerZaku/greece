...
public class GreekComponentVillageTorch extends GreekComponentVillage
{
    public GreekComponentVillageTorch() {}

    public GreekComponentVillageTorch(GreekComponentVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
    ...
    public static StructureBoundingBox func_74904_a(GreekComponentVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6)
    {
