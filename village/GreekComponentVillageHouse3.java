...
public class GreekComponentVillageHouse3 extends GreekComponentVillage
{
    public GreekComponentVillageHouse3() {}

    public GreekComponentVillageHouse3(GreekComponentVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
    ...
    public static GreekComponentVillageHouse3 func_74921_a(GreekComponentVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
        ...
        return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(par1List, structureboundingbox) == null ? new GreekComponentVillageHouse3(par0ComponentVillageStartPiece, par7, par2Random, structureboundingbox, par6) : null;
    }
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        System.out.println("Making a house3");
        ...
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 0, 0, 0, 0, 3, 5, Greece.mudbrick.blockID, Greece.mudbrick.blockID, false);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 8, 0, 0, 8, 3, 10, Greece.mudbrick.blockID, Greece.mudbrick.blockID, false);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 1, 0, 0, 7, 2, 0, Greece.mudbrick.blockID, Greece.mudbrick.blockID, false);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 1, 0, 5, 2, 1, 5, Greece.mudbrick.blockID, Greece.mudbrick.blockID, false);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 2, 0, 6, 2, 3, 10, Greece.mudbrick.blockID, Greece.mudbrick.blockID, false);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 3, 0, 10, 7, 3, 10, Greece.mudbrick.blockID, Greece.mudbrick.blockID, false);
        ...
        for (l = 4; l >= 1; --l)
        {
            ...
            for (i1 = 8 - l; i1 <= 10; ++i1)
            {
                this.placeBlockAtCurrentPosition(par1World, Greece.thatchSlope.blockID, k, l, 2 + l, i1, par3StructureBoundingBox);
            }
        }
        ...
        this.placeBlockAtCurrentPosition(par1World, Greece.thatchSlope.blockID, l, 6, 6, 4, par3StructureBoundingBox);
        int j1;
        ...
        for (i1 = 6; i1 <= 8; ++i1)
        {
            for (j1 = 5; j1 <= 10; ++j1)
            {
                this.placeBlockAtCurrentPosition(par1World, Greece.thatchSlope.blockID, l, i1, 12 - i1, j1, par3StructureBoundingBox);
            }
        }
        ...
        this.placeBlockAtCurrentPosition(par1World, Block.fence.blockID, 0, 8, 2, 7, par3StructureBoundingBox);
        this.placeBlockAtCurrentPosition(par1World, Block.fence.blockID, 0, 8, 2, 8, par3StructureBoundingBox);
        ...
        this.placeBlockAtCurrentPosition(par1World, Block.fence.blockID, 0, 2, 2, 7, par3StructureBoundingBox);
        this.placeBlockAtCurrentPosition(par1World, Block.fence.blockID, 0, 2, 2, 8, par3StructureBoundingBox);
        ...
        this.placeBlockAtCurrentPosition(par1World, Block.fence.blockID, 0, 5, 4, 10, par3StructureBoundingBox);
        ...
        for (i1 = 0; i1 < 5; ++i1)
        {
            for (j1 = 0; j1 < 9; ++j1)
            {
                ...
                this.fillCurrentPositionBlocksDownwards(par1World, Greece.mudbrick.blockID, 0, j1, -1, i1, par3StructureBoundingBox);
            }
        }
