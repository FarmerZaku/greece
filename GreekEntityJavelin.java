...
//HAS to extend EntityArrow, because otherwise there's a rendering bug due to not sending initial position. This is hardcoded in the base.
public class GreekEntityJavelin extends EntityArrow implements IProjectile
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    private boolean breakOnHit = false;
    ...
    private ItemStack toPickup;

    /** The amount of knockback an arrow applies when it hits a mob. */
    private int knockbackStrength;

    public GreekEntityJavelin(World par1World)
    {
        super(par1World);
    ...
    public GreekEntityJavelin(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public GreekEntityJavelin(World par1World, EntityLivingBase entity, EntityLivingBase par3EntityLivingBase, float par4, float par5)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
    ...
    public GreekEntityJavelin(World world, EntityLivingBase entity, float speed, ItemStack toPickup, boolean breakOnHit)
    {
        super(world);
        this.renderDistanceWeight = 10.0D;
        this.sourceEntity = entity;
    ...
    public void onUpdate()
    {
        ...
        else
        {
            ...
            if (movingobjectposition != null && movingobjectposition.entityHit != null && movingobjectposition.entityHit instanceof EntityPlayer)
            {
                ...
                if (entityplayer.capabilities.disableDamage || this.sourceEntity instanceof EntityPlayer && !((EntityPlayer)this.sourceEntity).canAttackPlayer(entityplayer))
                {
            ...
            if (movingobjectposition != null && collideable)
            {
                if (movingobjectposition.entityHit != null)
                {
                    ...
                    {
                        damagesource = DamageSource.causeThrownDamage(this, this.sourceEntity);
                    }
                    ...
                    if (movingobjectposition.entityHit.attackEntityFrom(damagesource, (float)i1))
                    {
                        if (movingobjectposition.entityHit instanceof EntityLivingBase)
                        {
                            ...
                            if (this.sourceEntity != null)
                            {
                                EnchantmentThorns.func_92096_a(this.sourceEntity, entitylivingbase, this.rand);
                            }

                            if (this.sourceEntity != null && movingobjectposition.entityHit != this.sourceEntity && movingobjectposition.entityHit instanceof EntityPlayer && this.sourceEntity instanceof EntityPlayerMP)
                            {
                                ((EntityPlayerMP)this.sourceEntity).playerNetServerHandler.sendPacketToPlayer(new Packet70GameEvent(6, 0));
                            }
                        }
